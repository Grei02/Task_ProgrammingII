...
public class PrincipalViewController extends Controller implements Initializable {
    ...
    public void updateCoopLogo() {
        // Esto es para cargar la imagen de la cooperativa, un classLoader es necesario para cargar la imagen
        ClassLoader classLoader = getClass().getClassLoader();
        Image image = new Image(classLoader.getResourceAsStream("cr/ac/una/taskprogrammingii/resources/LogoUNArojo.png"));
