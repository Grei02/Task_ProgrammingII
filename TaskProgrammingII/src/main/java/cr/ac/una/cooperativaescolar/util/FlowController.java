 ...
 */
package cr.ac.una.cooperativaescolar.util;

import cr.ac.una.cooperativaescolar.App;
...
import cr.ac.una.cooperativaescolar.controller.Controller;
...
public class FlowController {
    ...
    public void goViewInWindow(String viewName) {
        ...
        stage.getIcons().add(new Image("cr/ac/una/cooperativaescolar/resources/LogoUNArojo.png"));
