...
public class AssociateRegisterController extends Controller implements Initializable {
    ...
    public void userCard(){
        ...
        String backgroundImagePath="src/main/resources/cr/ac/una/cooperativaescolar/resources/UserCard.png";
